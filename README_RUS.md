...
- Сборка программы должна быть настроена с помощью Makefile со стандартным набором целей для GNU-программ: all, install, uninstall,clean, distclean, mostyclean, realclean, TAGS, info, dvi, dist. При этом установка должна вестись в каталог /opt/3dviewer/v1.0  
